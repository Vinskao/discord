...
public class Users {
    ...
    public Users(int id, String name, LocalDateTime hireDate, boolean isActive, boolean isAdmin,
    ...
    public Users hireDate(LocalDateTime hireDate) {
    ...
    public Users resignationDate(LocalDateTime resignationDate) {
