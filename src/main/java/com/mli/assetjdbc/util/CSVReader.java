	...
	public static List<Assets> readCSV(String filePath) {
        ...
        try (
            ...
            while ((nextLine = csvReader.readNext()) != null) {
                ...
                String unitOfUse = nextLine[3];
                String user = nextLine[4];
                
                // 日期格式
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy/MM/dd");
                String dateStr = nextLine[5];
                ...
                double value = Double.parseDouble(nextLine[6]);
                int unitId = Integer.parseInt(nextLine[7]);
                
                // 建立一個 Assets 物件並將其加入列表
                Assets asset = new Assets(id, assetNumber, assetName, unitOfUse, user, creationDate, value, unitId);
