...
public class AssetsDaoJdbc implements AssetsDao {
    ...
    public boolean insert(Assets asset) {
        ...
        return jdbcTemplate.update(sql, asset.getAssetNumber(), asset.getAssetName(), asset.getUnitOfUse(), asset.getUser(), asset.getCreationDate(), asset.getValue()) > 0;
    }
    ...
    public boolean update(Assets asset) {
        ...
        return jdbcTemplate.update(sql, asset.getAssetName(), asset.getUnitOfUse(), asset.getUser(), asset.getCreationDate(), asset.getValue(), asset.getAssetNumber()) > 0;
    }
